      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {featuresList.map((feature, index) => (
            ...
            >
              <div className="border border-amber-200 rounded-lg p-6 shadow-lg transition-shadow bg-white hover:shadow-xl text-center h-full flex flex-col">
                ...
                <p className="text-gray-700 text-sm flex-grow leading-relaxed mb-4">{feature.description}</p>
