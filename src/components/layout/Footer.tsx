...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-t border-slate-700 py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-green-700 pt-8 mb-8">
          <h3 className="text-white font-semibold mb-4 text-center">Our Services</h3>
        ...
        <div className="bg-green-800/50 rounded-lg p-4 text-center">
          <p className="text-sm text-white font-medium">
            ...
            call our 24/7 hotline: <span className="text-white font-bold">+254 799330345</span>
          </p>
        </div>
      </div>
    </footer>
