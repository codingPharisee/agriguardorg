            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">agrifacthubtech@gmail.com</p>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg shadow-lg p-8 border border-amber-200">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  AgriFact Hub Company is dedicated to providing accurate, science-based information 
